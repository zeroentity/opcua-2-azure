...
timeout = 241000
minimum_polling_time = 10  # this is for Cloud to Device messaging only
...
connection_string = "HostName=meag-iot-hub.azure-devices.net;DeviceId=MyMEAG1337;SharedAccessKey=q7yKa7N75ZhpNiAG9rZoUjQeMWvBj2Wu35wC5gGpnOI="

# this simple JSON message is the basis of sending data to Azure; Stream Analytics job will parse this info
msg_txt = '{{"deviceId": "my_MEAG","Step": {var1},"ActualRate": {var2},"TotalWeight": {var3},"AlarmNo": {var4}}}'
...
def iothub_client_sample_run():
    ...
    try:
        ...
        while True:
            # send a message based on polling time
            print("IoTHubClient sending %d messages" % message_count)

            for i in range(0, message_count):
                # this is where the MEAG data is put into the JSON message to Azure
                msg_txt_formatted = msg_txt.format(var1=meag_tcp.my_meag.step_number,
                                                   var2=float(meag_tcp.my_meag.actual_rate),
                                                   var3=meag_tcp.my_meag.total_weight,
                                                   var4=meag_tcp.my_meag.alarm_number)
